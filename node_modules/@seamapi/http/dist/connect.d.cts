...
declare class SeamHttpAccessGrantsUnmanaged {
    ...
    update(parameters?: AccessGrantsUnmanagedUpdateParameters, options?: AccessGrantsUnmanagedUpdateOptions): AccessGrantsUnmanagedUpdateRequest;
}
...
type AccessGrantsUnmanagedUpdateParameters = RouteRequestBody<'/access_grants/unmanaged/update'>;
/**
 * @deprecated Use AccessGrantsUnmanagedUpdateParameters instead.
 */
type AccessGrantsUnmanagedUpdateBody = AccessGrantsUnmanagedUpdateParameters;
/**
 * @deprecated Use AccessGrantsUnmanagedUpdateRequest instead.
 */
type AccessGrantsUnmanagedUpdateResponse = SetNonNullable<Required<RouteResponse<'/access_grants/unmanaged/update'>>>;
type AccessGrantsUnmanagedUpdateRequest = SeamHttpRequest<void, undefined>;
interface AccessGrantsUnmanagedUpdateOptions {
}
...
declare class SeamHttpAccessGrants {
    ...
    requestAccessMethods(parameters?: AccessGrantsRequestAccessMethodsParameters, options?: AccessGrantsRequestAccessMethodsOptions): AccessGrantsRequestAccessMethodsRequest;
...
type AccessGrantsRequestAccessMethodsParameters = RouteRequestBody<'/access_grants/request_access_methods'>;
/**
 * @deprecated Use AccessGrantsRequestAccessMethodsParameters instead.
 */
type AccessGrantsRequestAccessMethodsBody = AccessGrantsRequestAccessMethodsParameters;
/**
 * @deprecated Use AccessGrantsRequestAccessMethodsRequest instead.
 */
type AccessGrantsRequestAccessMethodsResponse = SetNonNullable<Required<RouteResponse<'/access_grants/request_access_methods'>>>;
type AccessGrantsRequestAccessMethodsRequest = SeamHttpRequest<AccessGrantsRequestAccessMethodsResponse, 'access_grant'>;
interface AccessGrantsRequestAccessMethodsOptions {
}
...
declare class SeamHttpAcsSystems {
    ...
    reportDevices(parameters?: AcsSystemsReportDevicesParameters, options?: AcsSystemsReportDevicesOptions): AcsSystemsReportDevicesRequest;
}
...
type AcsSystemsReportDevicesParameters = RouteRequestBody<'/acs/systems/report_devices'>;
/**
 * @deprecated Use AcsSystemsReportDevicesParameters instead.
 */
type AcsSystemsReportDevicesBody = AcsSystemsReportDevicesParameters;
/**
 * @deprecated Use AcsSystemsReportDevicesRequest instead.
 */
type AcsSystemsReportDevicesResponse = SetNonNullable<Required<RouteResponse<'/acs/systems/report_devices'>>>;
type AcsSystemsReportDevicesRequest = SeamHttpRequest<void, undefined>;
interface AcsSystemsReportDevicesOptions {
}
...
declare class SeamHttpSeamCustomerV1AccessGrants {
    client: Client;
    readonly defaults: Required<SeamHttpRequestOptions>;
    readonly ltsVersion = "1.0.0";
    static ltsVersion: string;
    constructor(apiKeyOrOptions?: string | SeamHttpOptions);
    static fromClient(client: SeamHttpOptionsWithClient['client'], options?: Omit<SeamHttpOptionsWithClient, 'client'>): SeamHttpSeamCustomerV1AccessGrants;
    static fromApiKey(apiKey: SeamHttpOptionsWithApiKey['apiKey'], options?: Omit<SeamHttpOptionsWithApiKey, 'apiKey'>): SeamHttpSeamCustomerV1AccessGrants;
    static fromClientSessionToken(clientSessionToken: SeamHttpOptionsWithClientSessionToken['clientSessionToken'], options?: Omit<SeamHttpOptionsWithClientSessionToken, 'clientSessionToken'>): SeamHttpSeamCustomerV1AccessGrants;
    static fromPublishableKey(publishableKey: string, userIdentifierKey: string, options?: SeamHttpFromPublishableKeyOptions): Promise<SeamHttpSeamCustomerV1AccessGrants>;
    static fromConsoleSessionToken(consoleSessionToken: SeamHttpOptionsWithConsoleSessionToken['consoleSessionToken'], workspaceId: SeamHttpOptionsWithConsoleSessionToken['workspaceId'], options?: Omit<SeamHttpOptionsWithConsoleSessionToken, 'consoleSessionToken' | 'workspaceId'>): SeamHttpSeamCustomerV1AccessGrants;
    static fromPersonalAccessToken(personalAccessToken: SeamHttpOptionsWithPersonalAccessToken['personalAccessToken'], workspaceId: SeamHttpOptionsWithPersonalAccessToken['workspaceId'], options?: Omit<SeamHttpOptionsWithPersonalAccessToken, 'personalAccessToken' | 'workspaceId'>): SeamHttpSeamCustomerV1AccessGrants;
    createPaginator<const TResponse, const TResponseKey extends keyof TResponse>(request: SeamHttpRequest<TResponse, TResponseKey>): SeamPaginator<TResponse, TResponseKey>;
    updateClientSessionToken(clientSessionToken: SeamHttpOptionsWithClientSessionToken['clientSessionToken']): Promise<void>;
...
type SeamCustomerV1AccessGrantsListParameters = RouteRequestBody<'/seam/customer/v1/access_grants/list'>;
/**
 * @deprecated Use SeamCustomerV1AccessGrantsListParameters instead.
 */
type SeamCustomerV1AccessGrantsListParams = SeamCustomerV1AccessGrantsListParameters;
/**
 * @deprecated Use SeamCustomerV1AccessGrantsListRequest instead.
 */
type SeamCustomerV1AccessGrantsListResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/access_grants/list'>>>;
type SeamCustomerV1AccessGrantsListRequest = SeamHttpRequest<SeamCustomerV1AccessGrantsListResponse, 'access_grants'>;
interface SeamCustomerV1AccessGrantsListOptions {
}
...
declare class SeamHttpSeamCustomerV1Connectors {
    client: Client;
    readonly defaults: Required<SeamHttpRequestOptions>;
    readonly ltsVersion = "1.0.0";
    static ltsVersion: string;
...
type SeamCustomerV1ConnectorsCreateParameters = RouteRequestBody<'/seam/customer/v1/connectors/create'>;
/**
 * @deprecated Use SeamCustomerV1ConnectorsCreateParameters instead.
 */
type SeamCustomerV1ConnectorsCreateBody = SeamCustomerV1ConnectorsCreateParameters;
/**
 * @deprecated Use SeamCustomerV1ConnectorsCreateRequest instead.
 */
type SeamCustomerV1ConnectorsCreateResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/connectors/create'>>>;
type SeamCustomerV1ConnectorsCreateRequest = SeamHttpRequest<SeamCustomerV1ConnectorsCreateResponse, 'connector'>;
interface SeamCustomerV1ConnectorsCreateOptions {
}
type SeamCustomerV1ConnectorsDeleteParameters = RouteRequestBody<'/seam/customer/v1/connectors/delete'>;
/**
 * @deprecated Use SeamCustomerV1ConnectorsDeleteParameters instead.
 */
type SeamCustomerV1ConnectorsDeleteBody = SeamCustomerV1ConnectorsDeleteParameters;
/**
 * @deprecated Use SeamCustomerV1ConnectorsDeleteRequest instead.
 */
type SeamCustomerV1ConnectorsDeleteResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/connectors/delete'>>>;
type SeamCustomerV1ConnectorsDeleteRequest = SeamHttpRequest<SeamCustomerV1ConnectorsDeleteResponse, 'connector'>;
interface SeamCustomerV1ConnectorsDeleteOptions {
}
type SeamCustomerV1ConnectorsListParameters = RouteRequestParams<'/seam/customer/v1/connectors/list'>;
/**
 * @deprecated Use SeamCustomerV1ConnectorsListParameters instead.
 */
type SeamCustomerV1ConnectorsListParams = SeamCustomerV1ConnectorsListParameters;
/**
 * @deprecated Use SeamCustomerV1ConnectorsListRequest instead.
 */
type SeamCustomerV1ConnectorsListResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/connectors/list'>>>;
type SeamCustomerV1ConnectorsListRequest = SeamHttpRequest<SeamCustomerV1ConnectorsListResponse, 'connectors'>;
interface SeamCustomerV1ConnectorsListOptions {
}
type SeamCustomerV1ConnectorsSyncParameters = RouteRequestBody<'/seam/customer/v1/connectors/sync'>;
/**
 * @deprecated Use SeamCustomerV1ConnectorsSyncParameters instead.
 */
type SeamCustomerV1ConnectorsSyncBody = SeamCustomerV1ConnectorsSyncParameters;
/**
 * @deprecated Use SeamCustomerV1ConnectorsSyncRequest instead.
 */
type SeamCustomerV1ConnectorsSyncResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/connectors/sync'>>>;
type SeamCustomerV1ConnectorsSyncRequest = SeamHttpRequest<SeamCustomerV1ConnectorsSyncResponse, 'connector_sync'>;
interface SeamCustomerV1ConnectorsSyncOptions {
}
type SeamCustomerV1ConnectorsUpdateParameters = RouteRequestBody<'/seam/customer/v1/connectors/update'>;
/**
 * @deprecated Use SeamCustomerV1ConnectorsUpdateParameters instead.
 */
type SeamCustomerV1ConnectorsUpdateBody = SeamCustomerV1ConnectorsUpdateParameters;
/**
 * @deprecated Use SeamCustomerV1ConnectorsUpdateRequest instead.
 */
type SeamCustomerV1ConnectorsUpdateResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/connectors/update'>>>;
type SeamCustomerV1ConnectorsUpdateRequest = SeamHttpRequest<SeamCustomerV1ConnectorsUpdateResponse, 'connector'>;
interface SeamCustomerV1ConnectorsUpdateOptions {
}
...
declare class SeamHttpSeamCustomerV1StaffMembers {
    client: Client;
    readonly defaults: Required<SeamHttpRequestOptions>;
    readonly ltsVersion = "1.0.0";
    static ltsVersion: string;
...
type SeamCustomerV1StaffMembersGetParameters = RouteRequestBody<'/seam/customer/v1/staff_members/get'>;
/**
 * @deprecated Use SeamCustomerV1StaffMembersGetParameters instead.
 */
type SeamCustomerV1StaffMembersGetParams = SeamCustomerV1StaffMembersGetParameters;
/**
 * @deprecated Use SeamCustomerV1StaffMembersGetRequest instead.
 */
type SeamCustomerV1StaffMembersGetResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/staff_members/get'>>>;
type SeamCustomerV1StaffMembersGetRequest = SeamHttpRequest<SeamCustomerV1StaffMembersGetResponse, 'staff_member'>;
interface SeamCustomerV1StaffMembersGetOptions {
}
type SeamCustomerV1StaffMembersListParameters = RouteRequestBody<'/seam/customer/v1/staff_members/list'>;
/**
 * @deprecated Use SeamCustomerV1StaffMembersListParameters instead.
 */
type SeamCustomerV1StaffMembersListParams = SeamCustomerV1StaffMembersListParameters;
/**
 * @deprecated Use SeamCustomerV1StaffMembersListRequest instead.
 */
type SeamCustomerV1StaffMembersListResponse = SetNonNullable<Required<RouteResponse<'/seam/customer/v1/staff_members/list'>>>;
type SeamCustomerV1StaffMembersListRequest = SeamHttpRequest<SeamCustomerV1StaffMembersListResponse, 'staff_members'>;
interface SeamCustomerV1StaffMembersListOptions {
}
...
type UserIdentitiesUnmanagedUpdateParameters = RouteRequestBody<'/user_identities/unmanaged/update'>;
/**
 * @deprecated Use UserIdentitiesUnmanagedUpdateParameters instead.
 */
type UserIdentitiesUnmanagedUpdateBody = UserIdentitiesUnmanagedUpdateParameters;
/**
 * @deprecated Use UserIdentitiesUnmanagedUpdateRequest instead.
 */
type UserIdentitiesUnmanagedUpdateResponse = SetNonNullable<Required<RouteResponse<'/user_identities/unmanaged/update'>>>;
type UserIdentitiesUnmanagedUpdateRequest = SeamHttpRequest<void, undefined>;
interface UserIdentitiesUnmanagedUpdateOptions {
}
...
declare class SeamHttpEndpoints {
    ...
    get '/seam/customer/v1/access_grants/list'(): (parameters?: SeamCustomerV1AccessGrantsListParameters, options?: SeamCustomerV1AccessGrantsListOptions) => SeamCustomerV1AccessGrantsListRequest;
    ...
    get '/seam/customer/v1/connectors/delete'(): (parameters?: SeamCustomerV1ConnectorsDeleteParameters, options?: SeamCustomerV1ConnectorsDeleteOptions) => SeamCustomerV1ConnectorsDeleteRequest;
    get '/seam/customer/v1/connectors/list'(): (parameters?: SeamCustomerV1ConnectorsListParameters, options?: SeamCustomerV1ConnectorsListOptions) => SeamCustomerV1ConnectorsListRequest;
    get '/seam/customer/v1/connectors/sync'(): (parameters?: SeamCustomerV1ConnectorsSyncParameters, options?: SeamCustomerV1ConnectorsSyncOptions) => SeamCustomerV1ConnectorsSyncRequest;
    get '/seam/customer/v1/connectors/update'(): (parameters?: SeamCustomerV1ConnectorsUpdateParameters, options?: SeamCustomerV1ConnectorsUpdateOptions) => SeamCustomerV1ConnectorsUpdateRequest;
