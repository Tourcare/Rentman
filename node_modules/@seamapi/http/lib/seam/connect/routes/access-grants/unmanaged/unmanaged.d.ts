...
export declare class SeamHttpAccessGrantsUnmanaged {
    client: Client;
...
export type AccessGrantsUnmanagedGetParameters = RouteRequestBody<'/access_grants/unmanaged/get'>;
/**
 ...
 */
export type AccessGrantsUnmanagedGetResponse = SetNonNullable<Required<RouteResponse<'/access_grants/unmanaged/get'>>>;
export type AccessGrantsUnmanagedGetRequest = SeamHttpRequest<AccessGrantsUnmanagedGetResponse, 'access_grant'>;
export interface AccessGrantsUnmanagedGetOptions {
}
export type AccessGrantsUnmanagedListParameters = RouteRequestBody<'/access_grants/unmanaged/list'>;
/**
 * @deprecated Use AccessGrantsUnmanagedListParameters instead.
 */
export type AccessGrantsUnmanagedListParams = AccessGrantsUnmanagedListParameters;
/**
 * @deprecated Use AccessGrantsUnmanagedListRequest instead.
 */
export type AccessGrantsUnmanagedListResponse = SetNonNullable<Required<RouteResponse<'/access_grants/unmanaged/list'>>>;
export type AccessGrantsUnmanagedListRequest = SeamHttpRequest<AccessGrantsUnmanagedListResponse, 'access_grants'>;
export interface AccessGrantsUnmanagedListOptions {
}
export type AccessGrantsUnmanagedUpdateParameters = RouteRequestBody<'/access_grants/unmanaged/update'>;
/**
 * @deprecated Use AccessGrantsUnmanagedUpdateParameters instead.
 */
export type AccessGrantsUnmanagedUpdateBody = AccessGrantsUnmanagedUpdateParameters;
/**
 * @deprecated Use AccessGrantsUnmanagedUpdateRequest instead.
 */
export type AccessGrantsUnmanagedUpdateResponse = SetNonNullable<Required<RouteResponse<'/access_grants/unmanaged/update'>>>;
export type AccessGrantsUnmanagedUpdateRequest = SeamHttpRequest<void, undefined>;
