...
export type AccessGrantsRequestAccessMethodsParameters = RouteRequestBody<'/access_grants/request_access_methods'>;
/**
 * @deprecated Use AccessGrantsRequestAccessMethodsParameters instead.
 */
export type AccessGrantsRequestAccessMethodsBody = AccessGrantsRequestAccessMethodsParameters;
/**
 * @deprecated Use AccessGrantsRequestAccessMethodsRequest instead.
 */
export type AccessGrantsRequestAccessMethodsResponse = SetNonNullable<Required<RouteResponse<'/access_grants/request_access_methods'>>>;
export type AccessGrantsRequestAccessMethodsRequest = SeamHttpRequest<AccessGrantsRequestAccessMethodsResponse, 'access_grant'>;
