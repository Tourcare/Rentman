...
export type AcsSystemsReportDevicesParameters = RouteRequestBody<'/acs/systems/report_devices'>;
/**
 ...
 */
export type AcsSystemsReportDevicesResponse = SetNonNullable<Required<RouteResponse<'/acs/systems/report_devices'>>>;
