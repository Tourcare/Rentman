...
export type UserIdentitiesUnmanagedUpdateParameters = RouteRequestBody<'/user_identities/unmanaged/update'>;
/**
 * @deprecated Use UserIdentitiesUnmanagedUpdateParameters instead.
 */
export type UserIdentitiesUnmanagedUpdateBody = UserIdentitiesUnmanagedUpdateParameters;
/**
 * @deprecated Use UserIdentitiesUnmanagedUpdateRequest instead.
 */
export type UserIdentitiesUnmanagedUpdateResponse = SetNonNullable<Required<RouteResponse<'/user_identities/unmanaged/update'>>>;
export type UserIdentitiesUnmanagedUpdateRequest = SeamHttpRequest<void, undefined>;
