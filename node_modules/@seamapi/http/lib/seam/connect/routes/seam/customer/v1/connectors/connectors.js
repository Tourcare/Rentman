...
export class SeamHttpSeamCustomerV1Connectors {
    ...
    static async fromPublishableKey(publishableKey, userIdentifierKey, options = {}) {
        ...
        if (isSeamHttpOptionsWithClient(clientOptions)) {
            throw new SeamHttpInvalidOptionsError('The client option cannot be used with SeamHttpSeamCustomerV1Connectors.fromPublishableKey');
        }
        ...
        return SeamHttpSeamCustomerV1Connectors.fromClientSessionToken(token, options);
    }
