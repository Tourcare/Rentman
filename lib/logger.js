...
function createLogger() {
    ...
    // AWS CloudWatch og SNS er deaktiveret
    // Kan genaktiveres ved at sætte ENABLE_AWS_LOGGING=true i .env
    if (config.isProduction && process.env.ENABLE_AWS_LOGGING === 'true') {
