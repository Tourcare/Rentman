 ...
 * Database Module
 *
 * Håndterer al database kommunikation med MySQL til sync tracking
 * (synced_companies, synced_deals, etc.). Mappings mellem Rentman og HubSpot IDs.
 */
...
// Connection pool - oprettes ved modul load
